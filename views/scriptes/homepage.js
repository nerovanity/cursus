...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  document.getElementById("add_admin").addEventListener("click", function () {
    window.location.assign("http://127.0.0.1:8000/add_admin");
  });
});
/////////////////////////////////////////////////////////////////
const sup = async (id) => {
...
document.addEventListener("click", (event) => {
  if (event.target.classList.contains("btn-cursus")) {
    const userId = event.target.dataset.id;
    localStorage.setItem('userId', userId);
    document.location.assign(`http://127.0.0.1:8000/cursus`);
  }
});
/////////////////////////////////////////////////////////////////////////////////////
//sreach
...
document.getElementById('admin_list').addEventListener('click', () =>{
